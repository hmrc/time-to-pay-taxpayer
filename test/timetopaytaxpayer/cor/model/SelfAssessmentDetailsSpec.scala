...
class SelfAssessmentDetailsSpec extends AnyWordSpecLike with Matchers {

  "SelfAssessmentDetails" should {
    ...
    "have an obfuscate method" in {
      saBeforeFix.obfuscate shouldBe saBeforeFix.copy(utr = SaUtr("1234***"))
    }
    ...
    "have a format instance" in {
      ...
      expectedJson.validate[SelfAssessmentDetails] shouldBe JsSuccess(saBeforeFix)
    }
