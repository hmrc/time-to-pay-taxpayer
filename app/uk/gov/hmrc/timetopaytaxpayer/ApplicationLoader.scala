...
class ApplicationModule(context: Context) extends BuiltInComponentsFromContext(context) {
  ...
  /**
    * Calls the 3 eligibility DES APIS; getSAReturns, getSADebits and getCommPreferences
    */
  ...
  /**
    * Calls the SA service and returns the user's address and other personal details such as name
    */
